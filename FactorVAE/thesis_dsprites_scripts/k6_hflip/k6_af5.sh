...
nice python main.py --seed 1 \
 ...
 --name hflip_k6_af5_seed1 --z_dim 10 --gamma 10 --ckpt_load last --ckpt_save_iter 175_000
...
nice python main.py --seed 2 \
 ...
 --lr_VAE 1e-4 --beta1_VAE 0.9 --beta2_VAE 0.999 --lr_D 1e-4 --beta1_D 0.5 --beta2_D 0.9 \
 --use_augment_dataloader --augment_choice 3 --num_sim_factors 6 --augment_factor 5 \
 --name hflip_k6_af5_seed2 --z_dim 10 --gamma 10 --ckpt_load last --ckpt_save_iter 175_000
...
nice python main.py --seed 3 \
 ...
 --lr_VAE 1e-4 --beta1_VAE 0.9 --beta2_VAE 0.999 --lr_D 1e-4 --beta1_D 0.5 --beta2_D 0.9 \
 --use_augment_dataloader --augment_choice 3 --num_sim_factors 6 --augment_factor 5 \
 --name hflip_k6_af5_seed3 --z_dim 10 --gamma 10 --ckpt_load last --ckpt_save_iter 175_000
...
nice python main.py --seed 4 \
 ...
 --lr_VAE 1e-4 --beta1_VAE 0.9 --beta2_VAE 0.999 --lr_D 1e-4 --beta1_D 0.5 --beta2_D 0.9 \
 --use_augment_dataloader --augment_choice 3 --num_sim_factors 6 --augment_factor 5 \
 --name hflip_k6_af5_seed4 --z_dim 10 --gamma 10 --ckpt_load last --ckpt_save_iter 175_000
...
nice python main.py --seed 5 \
 ...
 --lr_VAE 1e-4 --beta1_VAE 0.9 --beta2_VAE 0.999 --lr_D 1e-4 --beta1_D 0.5 --beta2_D 0.9 \
 --use_augment_dataloader --augment_choice 3 --num_sim_factors 6 --augment_factor 5 \
 --name hflip_k6_af5_seed5 --z_dim 10 --gamma 10 --ckpt_load last --ckpt_save_iter 175_000