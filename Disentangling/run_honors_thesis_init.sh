...
nice python3 main.py --train True --seed 1 --cuda False --gpu 0 --max_iter 1.5e6 --batch_size 64 \
    ...
    --num_workers 4 --viz_on True --viz_name Honors_Thesis_First_Run --viz_port 8097 --save_output True \
