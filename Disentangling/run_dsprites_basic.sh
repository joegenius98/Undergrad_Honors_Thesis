...
python3 main.py --train True --seed 1 --cuda True --gpu 0 --max_iter 1.5e6 --batch_size 64 \
    ...
    --output_dir ./outputs --gather_step 10000 --save_step 10000 --ckpt_dir ./checkpoints --ckpt_name last 