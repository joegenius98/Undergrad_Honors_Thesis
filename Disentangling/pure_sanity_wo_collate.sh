...
nice python main.py --train True --seed 1 --cuda True --gpu 1 --max_iter 1.5e6 --batch_size 64 \
    ...
    --viz_on True --viz_name Honors_Thesis_Sanity --viz_port 8097 --gather_step 10000 \
